...
<div style="height:100vh;width:100%; background-color: #141414;">
	...
	<div style="float: left;">
		<a href="<?php echo base_url();?>">
			<img src="<?php echo base_url();?>/assets/global/logo.png" style="margin: 18px 40px; height: 45px;" />
		</a>
	</div>
	<div style="clear: both; text-align: center; padding-top: 100px;">
		...
		<br>
		<a href="<?php echo base_url();?>index.php?browse/switchprofile" class="profile_manage_done">DONE</a>
	</div>
</div>