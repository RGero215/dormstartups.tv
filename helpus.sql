...
--
-- Host: localhost
-- Generation Time: Jul 22, 2018 at 07:41 PM
...
(9, 'Organization', 'organization', NULL, '2018-07-12 10:26:46', '2018-07-12 10:26:46');
...
(46, 6, 'Android Business APP.zip', 'android-business-app', 'android-business-app.zip', '1035', 'application/zip', 0, '2018-07-22 03:57:39', '2018-07-22 03:57:39'),
(47, 5, 'Android Business APP.zip', 'android-business-app-1', 'android-business-app-1.zip', '1035', 'application/zip', 0, '2018-07-22 11:14:38', '2018-07-22 11:14:38');
...
(7, 'Kathy R. Gilkey', 'KathyRGilkey@jourrapide.com', 7, 3, 25, '10.00', 'stripe', 'success', 'USD', NULL, '4242', 'card_1CqeoJIdV7MTb07G5JP7mtFg', 'Visa', NULL, '12', '2019', NULL, 'ch_1CqeoPIdV7MTb07GW0EbMKWN', NULL, 'World\'s most efficient small pc [Contributing]', NULL, 1532255353, 'full_name', NULL, NULL, NULL, NULL, NULL, NULL, '2018-07-22 04:29:14', '2018-07-22 04:29:14');
...
CREATE TABLE `rewards` (
  ...
  `digital_downloads` int(11) DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
...
INSERT INTO `rewards` (`id`, `user_id`, `campaign_id`, `amount`, `description`, `estimated_delivery`, `quantity`, `equity_share_percent`, `digital_downloads`) VALUES
(1, 1, 1, '30.00', '1 honorary crest with bless. child will be happy with your donation, you are invited to visit', '2018-12', 40, NULL, NULL),
(3, 1, 1, '40.00', 'You are geek, your name will be print in our nameplate with a historic sign as doner', '2018-11', 1, NULL, NULL),
(4, 5, 4, '50.00', 'There are many variations of passages of Lorem Ipsum available, but the majority have suffered alteration in some form, by injected humour', '2023-01', 10, NULL, NULL),
(5, 6, 8, '15.00', 'The nature will save, you will get 15 HD photos', '2020-06', 10, NULL, NULL),
(6, 6, 8, '25.00', 'It is a long established fact that a reader will be distracted by the readable content of a page when looking at its layout.', '2021-10', 5, NULL, NULL),
(7, 6, 9, '35.00', 'Lorem Ipsum is simply dummy text of the printing and typesetting industry', '2022-07', 20, NULL, NULL),
(8, 6, 9, '45.00', 'Lorem Ipsum is simply dummy text of the printing and typesetting industry', '2021-10', 15, NULL, NULL),
(9, 6, 9, '55.00', 'Lorem Ipsum is simply dummy text of the printing and typesetting industry', '2021-10', 10, NULL, NULL),
(10, 6, 6, '50.00', 'Lorem Ipsum is simply dummy text of the printing and typesetting industry.', '2022-11', 20, NULL, NULL),
(11, 6, 6, '70.00', 'Lorem Ipsum is simply dummy text of the printing and typesetting industry.', '2023-07', 25, NULL, NULL),
(12, 6, 6, '80.00', 'Lorem Ipsum is simply dummy text of the printing and typesetting industry.', '2022-11', 30, NULL, NULL),
(13, 6, 6, '90.00', 'Lorem Ipsum is simply dummy text of the printing and typesetting industry. \r\nLorem Ipsum is simply dummy text of the printing and typesetting industry.', '2023-07', 35, NULL, NULL),
(14, 6, 6, '100.00', 'Lorem Ipsum is simply dummy text of the printing and typesetting industry.', '2023-12', 10, NULL, NULL),
(15, 1, 10, '20.00', 'Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the industry\'s standard dummy text ever since the 1500s.', '2024-11', 80, NULL, NULL),
(16, 5, 17, '100.00', '10 packs injections (20 injection each pack)\r\nDownload App', '2024-02', 50, NULL, 47),
(17, 5, 17, '200.00', '30 packs injections (10 items each pack)', '2024-07', 60, NULL, NULL),
(18, 5, 16, '100.00', '1 coffee machine will send you to use it or resale', '2024-02', 100, NULL, NULL),
(19, 5, 16, '150.00', '2 coffee machine you will get to use or resale', '2024-05', 120, NULL, NULL),
(20, 5, 16, '200.00', '3 coffee machine you will get to use it or gift to your nearest person', '2024-05', 200, NULL, NULL),
(21, 5, 5, '40.00', 'A car will be sent to you for your personal  purpose and you can\'t sell it again', '2025-02', 10, NULL, NULL),
(22, 5, 5, '80.00', 'Car tyre you will get for re-sell, enjoy this reward', '2024-07', 50, NULL, NULL),
(23, 5, 5, '100.00', '4 refurbished car you can sell after getting from us, we will send you as soon as possible', '2024-12', 60, NULL, NULL),
(24, 5, 5, '160.00', 'Get 3% share from our company and you will get the revenue equally', '2023-11', 10, NULL, NULL),
(25, 6, 7, '10.00', 'You are able to download an android app to manage your business page by login with your user ID and password', '2023-11', 10, NULL, 46),
(26, 6, 9, '70.00', 'Download The App to control this watch from any where', '2025-02', 150, NULL, 46),
(27, 5, 16, '120.00', 'Mobile App available (Digital Download Content) to check the coffee machine health and status of coffee cost', '2024-11', 300, NULL, 47),
(28, 5, 14, '20.00', 'Digital Downloads available and you will get an App to control this robots', '2024-10', 200, NULL, 47);
...
(6, 'Kimberly A. Harrison', 'admin@demo.com', '$2y$10$HdzFUGG7xTJGgj.3Pr5PhO.p0KtESK6.Y0J.Z/0kzBu/jL0Q4v8Z2', 235, 'male', 'London, UK', NULL, '02569841', '9', 'admin', 1, NULL, NULL, NULL, 'niu7GpS8DcGDTVovRdI8L7iIFQxz011To0arHrQicqenUMueY8i3OOMadp3L', '2017-04-02 09:05:33', '2018-05-14 13:27:28');
